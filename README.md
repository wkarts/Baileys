...
Baileys and its maintainers cannot be held liable for misuse of this application, as stated in the [MIT license](https://github.com/wkarts/Baileyss/blob/master/LICENSE).
...
```
yarn add github:wkarts/Baileyss
```
